...
export async function checkPayments() {
  ...
  const backendPaymentsSummary = await getBackendPaymentsSummary(from, to);
  console.log("pp_default:", defaultAdminPaymentsSummary)
  console.log("pp_fallback:", fallbackAdminPaymentsSummary)
  console.log("backend_summary:", backendPaymentsSummary)
